...
public class Library implements Serializable {
	...
	public Appliance addModel( String typeOfAppliance, double price, String brandName, String modelName,
		...
		case "1" : 
			Appliance washer = new Appliance(brandName, modelName, price);
			washer.monthlyRepairPlanCost = monthlyRepairPlanCost; 
			washer.applianceType = "washerType";
			catalog.insertAppliance(washer); 
			break;
			
		case "2" : 
			Appliance dryer = new Appliance(brandName, modelName, price);
			dryer.monthlyRepairPlanCost = monthlyRepairPlanCost; 
		...
		case "3" : 
			Appliance kitchenRange = new Appliance(brandName, modelName, price);
			kitchenRange.applianceType = "kitchenRangeType";
			catalog.insertAppliance(kitchenRange);
			break;
		
		case "4" :  
			Appliance dishwasher = new Appliance(brandName, modelName, price);
		...
		// refrigerators
		case "5" : 
			Appliance refrigerator = new Appliance(brandName, modelName, price);
		...
		// furnaces 
		case "6" : 
			Appliance furnace = new Appliance(brandName, modelName, price);
